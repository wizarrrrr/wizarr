...
[View Documentation](https://github.com/wizarrrrrr/wizarr/tree/v2)
{% endhint %}
...
services:
  wizarr:
    ...
    image: ghcr.io/wizarrrrrr/wizarr
    ports:
      - 5690:5690
    volumes:
...
```bash
docker pull ghcr.io/wizarrrrrr/wizarr
```
