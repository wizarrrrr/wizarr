...
- Server - [`/server`](https://github.com/wizarrrrr/wizarr/tree/main/server)
- Web app - [`/web`](https://github.com/wizarrrrr/wizarr/tree/main/web)
- Machine learning - [`/machine-learning`](https://github.com/wizarrrrr/wizarr/tree/main/machine-learning)
- Redis
...
1. Build the Wizarr SDK - `cd open-api/typescript-sdk && npm i && npm run build && cd -`
2. Enter the web directory - `cd web/`
3. Install web dependencies - `npm i`
4. Start the web development server

```bash
WIZARR_SERVER_URL=https://demo.immich.app/ npm run dev
```

#### `@immich/ui`

To see local changes to `@immich/ui` in Wizarr, do the following:
