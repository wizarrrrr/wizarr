...
In JSON format, create a new config file (e.g. `immich.json`) and put it in a location that can be accessed by Wizarr.
...
In your `.env` file, set the variable `WIZARR_CONFIG_FILE` to the path of your config.
