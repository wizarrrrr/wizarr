  ...
  return (
    <header>
      ...
      <section className="text-center pt-12 sm:pt-24 bg-wizarr-bg/50 dark:bg-wizarr-dark-bg/80">
        <img
          src={'img/logo.svg'}
          className="h-[115px] w-[115px] mb-2 antialiased rounded"
          alt="Wizarr logo"
        />
        <div className="mt-8">
        ...
        <div className="flex flex-col sm:flex-row place-items-center place-content-center mt-9 gap-4 ">
          <Link
            className="flex place-items-center place-content-center py-3 px-8 border bg-wizarr-primary dark:bg-wizarr-dark-primary rounded-xl no-underline hover:no-underline text-white hover:text-gray-50 dark:text-wizarr-dark-bg font-bold uppercase"
          ...
          <Link
            className="flex place-items-center place-content-center py-3 px-8 border bg-wizarr-primary/10 dark:bg-gray-300  rounded-xl hover:no-underline text-wizarr-primary dark:text-wizarr-dark-bg font-bold uppercase"
            to="https://demo.wizarr.org/"
          >
            Demo
          </Link>
        </div>
