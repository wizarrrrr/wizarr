import { mdiServer, mdiWizardHat } from "@mdi/js";
...
const withRelease = ({ icon, iconColor, title, description, release: version }: Base & { release: keyof typeof releases }) => {
    return {
        icon,
    ...
    return (
        <Layout title={title} description={description}>
            <section className="my-8">
                <h1 className="md:text-6xl text-center mb-10 text-wizarr-primary dark:text-wizarr-dark-primary px-2">{title}</h1>
