<template>
    <div class="flex flex-col space-y-4">
        <p>
            {{ __("Please login to your Plex account to help us connect you to our server.") }}
        </p>
...
export default defineComponent({
    ...
    methods: {
        async login() {
            ...
            const confirm = await this.$modal.confirmModal(this.__("Plex Warning"), this.__("Wizarr is an unverified app. This means that Plex may warn you about using it. Do you wish to continue?"), { confirmButtonText: this.__("Okay") });
