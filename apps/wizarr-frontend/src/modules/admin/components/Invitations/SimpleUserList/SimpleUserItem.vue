<template>
    <div class="flex flex-row text-gray-900 overflow-hidden px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-white transition duration-150 ease-in-out">
        <div class="flex flex-grow items-center justify-start space-x-0 md:space-x-3 w-2/3">
            <div class="aspect-square h-full hidden md:flex items-center justify-center">
