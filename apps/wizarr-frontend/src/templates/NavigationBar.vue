...
<template>
    <StickyElement>
        <Disclosure as="nav" style="z-index: 22" class="bg-white dark:bg-gray-900 absolute w-full top-0 left-0 right-0 border-b border-gray-200 dark:border-gray-600 md:h-[64px]" v-slot="{ open }">
