...
console.log(`%cWizarr Server\n%cWizarr - MIT License - https://wizarr.dev - https://github.com/wizarrrrrr/wizarr`, "color: #FE4155; -webkit-text-stroke: 2px #FE4155; font-size: 72px; font-weight: bold;", "color: #00A2E8; font-size: 10px; font-weight: bold;");
